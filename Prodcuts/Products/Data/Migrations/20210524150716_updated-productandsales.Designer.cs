...
namespace Products.Data.Migrations
{
    ...
    [Migration("20210524150716_updated-productandsales")]
    partial class updatedproductandsales
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Products.Models.ModeOfPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Products.Models.Sale", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Products.Models.SubCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Products.Models.Product", b =>
                {
                    b.HasOne("Products.Models.ProductModel", "ProductModel")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Products.Models.ProductModel", b =>
                {
                    b.HasOne("Products.Models.SubCategory", "SubCategory")
            ...
            modelBuilder.Entity("Products.Models.Sale", b =>
                {
                    b.HasOne("Products.Models.ModeOfPayment", "ModeOfPayment")
                        .WithMany()
