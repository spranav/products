...
namespace Products.Controllers
{
    public class ProductModelsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.ProductModels.Include(p => p.SubCategory);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,SubCategoryId")] ProductModel productModel)
        {
            ...
            ViewData["SubCategoryId"] = new SelectList(_context.SubCategories, "Id", "Name", productModel.SubCategoryId);
            return View(productModel);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,SubCategoryId")] ProductModel productModel)
        {
